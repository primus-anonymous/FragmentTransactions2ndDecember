...
public class ThreeFragment extends Fragment {
    ...
    public void onStart() {
        ...
        Toast.makeText(requireContext(), "Three started", Toast.LENGTH_SHORT).show();
    }
    ...
    public void onStop() {
        ...
        Toast.makeText(requireContext(), "Three stopped", Toast.LENGTH_SHORT).show();
    }

    public void showMessage() {
        Toast.makeText(requireContext(), "Hi there three!", Toast.LENGTH_SHORT).show();
